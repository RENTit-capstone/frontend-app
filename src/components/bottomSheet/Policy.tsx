...
const PolicyModal = () => {
    ...
    return (
        <ScrollView style={[Common.wrapper, {marginBottom: 64}]}>
            ...
            <ScrollView style={[Common.wrapper, {borderColor: Colors.optionText, borderWidth: 1,borderRadius: 8, marginVertical: 10}]}>
            ...
            <ScrollView style={[Common.wrapper, {height: 250, borderColor: Colors.optionText, borderWidth: 1,borderRadius: 8, marginVertical: 10}]}>
