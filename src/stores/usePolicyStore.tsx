...
type PolicyState = {
    ...
    resolve?: (result: {flawPolicy: boolean | undefined; damagePolicy: boolean | undefined}) => void;

    openPolicy: () => Promise<{ flawPolicy: boolean | undefined; damagePolicy: boolean | undefined}>;
